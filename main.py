...
for i in range(10):
    dailyRow = dailyRow + str(dict(topNewsToday['top_news'][i])['news'][0]['id']) + "," + str(dict(topNewsToday['top_news'][i])['news'][0]['title']).replace(",","_") + "," + str(dict(topNewsToday['top_news'][i])['news'][0]['text']).replace(",","_")
